...
class TestGoogleCalendarScheduler:
    ...
    def google_calendar_scheduler(self):
        ...
        with patch('src.scheduling.google_calendar.service_account.Credentials.from_service_account_file') as mock_creds:
    ...
    def test_create_event(self, google_calendar_scheduler):
        ...
        mock_response = {'id': 'event123'}
        google_calendar_scheduler.service.events().insert().execute.return_value = mock_response
        ...
        google_calendar_scheduler.service.events().insert.assert_called_once()
